                                ...
                                <div class="card card-default">
                                    ...
                                    <div class="card-body p-0">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tr>
                                                <th>Income/Month</th>
                                                <td class="text-muted">Rp. 300.000</td>
                                            </tr>
                                            <tr>
                                                <th>Validator</th>
                                                <td class="text-muted">-</td>
                    ...
                    <section class="validation-section mb-5">
                        <div class="section-header mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a href="" class="btn btn-primary btn-lg btn-block">+ Add Installment Cars</a>
                                </div>
                            </div>
                        </div>
                        <div class="section-body">
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="card card-default">
                                        <div class="card-header border-0">
                                            <h5 class="mb-0">Nissan Livina</h5>
                                        </div>
                                        <div class="card-body p-0">
                                            <table class="table table-striped mb-0">
                                                <tr>
                                                    <th>Description</th>
                                                    <td class="text-muted">Family Cars for everyone</td>
                                                </tr>
                                                <tr>
                                                    <th>Price</th>
